...
def run_all_case(mobile_system):
    ...
    cmd = 'allure generate ./Report/{} -o ./Report/{}/allure-results --clean'.format(mobile_system.replace(" ", "_"), mobile_system.replace(" ", "_"))
    ...
    # 打印url，方便直接访问
    url = '报告链接：http://127.0.0.1:63342/{}/Report/{}/allure-results/index.html'.format(root_dir.split('/')[-1], mobile_system.replace(" ", "_"))
    print(url)
